...
public class Base64Coder {
    ...
    public static char[] encode(byte[] in) {
        return encodeBytes(in).toCharArray();
    }
    ...
    public static char[] encode(byte[] in, int iLen) {
        return encodeBytes(in, 0, iLen).toCharArray();
    }
     ...
     * @return A String containing the decoded data or null if exception is caught.
     */
    public static String decodeString(String s) {
        try {
            // no throwingexception for compatibility resons with old class
     ...
     */
    public static byte[] decode(char[] in) throws java.io.IOException {
        return decode(new String(in));
    }
}   // end class Base64